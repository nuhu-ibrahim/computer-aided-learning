...
class Attachment extends \AppBundle\Entity\Attachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Attachment' . "\0" . 'attachment_id', '' . "\0" . 'AppBundle\\Entity\\Attachment' . "\0" . 'post_id', '' . "\0" . 'AppBundle\\Entity\\Attachment' . "\0" . 'post_title', '' . "\0" . 'AppBundle\\Entity\\Attachment' . "\0" . 'attachment', '' . "\0" . 'AppBundle\\Entity\\Attachment' . "\0" . 'attachment_desc'];
        }
